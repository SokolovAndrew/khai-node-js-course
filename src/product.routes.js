...
router.get('/products/:brand', blockSpecialBrand, (request, response) => {
   const brand = request.params.brand; // Access the brand parameter from the URL
...
router.get('/products/:id/product', (request, response) => {
    const id = Number(request.params.id); // Access the id parameter from the URL
